...
augroup PlugGxGroup
  ...
  autocmd FileType vim nnoremap <buffer> <silent> gxx :call PlugGx()<cr>
augroup END 

" Allow open package.json with 'gx'
...
" =====================================
" note-taker for build pdf file
" =====================================
autocmd BufWritePost *note-*.md silent !$HOME/bin/buildNote.sh %:p
